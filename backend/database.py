...
def _migrate_price_alerts_sound_type(cursor) -> None:
    """Add sound_type column to price_alerts if missing (v3.1 migration)."""
...
def init_all_tables(db_path: str | None = None) -> None:
    ...
    try:
        ...
        _migrate_price_alerts_sound_type(cursor)
