...
# Module-level RLock serialises all multi-step write operations so that
# concurrent requests cannot interleave between the "deactivate-all" step and
# the subsequent insert/update, which would leave 0 or 2+ active providers.
