...
# Module-level lock serialises all multi-step write sequences.
# Identical pattern to VO-344 (scheduler.py).  Reads stay unlocked;
# SQLite WAL mode handles read-read concurrency at the engine level.
