// ============================================================
// TickerPulse AI v3.0 - Timezone-aware time formatting
// ============================================================
...
function resolveTimeZone(tz: TimezoneMode): string {
  return tz === 'ET' ? ET_TIMEZONE : Intl.DateTimeFormat().resolvedOptions().timeZone;
}

/**
 * Format an ISO timestamp to a short time string with explicit timezone label.
...
/**
 * Format an ISO timestamp to a long date+time string with explicit timezone label.
